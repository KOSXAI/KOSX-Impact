/**
 * 主题三态机：system（默认，跟随系统并实时响应系统切换）/ light / dark。
 * 用户选择持久化在 localStorage["kosx:theme"]；真正翻样式的是 html 上的
...
export const THEME_STORAGE_KEY = "kosx:theme";
