      ...
      <section className="order-1 flex flex-col rounded-2xl bg-surface shadow-[var(--panel-elev)] p-5">
        ...
        {champ ? (
          <>
            ...
            <Link to="/members" search={{ view: "growth", metric: "growth", range: 7 }} className="mt-auto block pt-3 text-xs font-semibold text-signal underline-offset-4 hover:underline">
              完整成长榜 →
            </Link>
          </>
        ) : (
      ...
      <section className="order-2 flex flex-col rounded-2xl bg-signal/5 p-5">
        ...
        {postRanks[0] ? (
          <>
            ...
            <Link to="/posts" className="mt-auto block pt-3 text-xs font-semibold text-signal underline-offset-4 hover:underline">
              完整推文榜 →
            </Link>
          </>
        ) : (
      ...
      <section className="order-3 flex flex-col rounded-2xl bg-surface shadow-[var(--panel-elev)] p-5">
        ...
        {racers.length > 0 ? (
          <>
            ...
            <Link to="/members" search={{ view: "growth", metric: "growth", range: 30 }} className="mt-auto block pt-3 text-xs font-semibold text-signal underline-offset-4 hover:underline">
              看全员冲关 →
            </Link>
          </>
        ) : (
