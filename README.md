...
- [x] 共同关注与社群品味：SocialData following 采样聚合「成员们共同关注的大V」+ 帖子正文「社群热议」外部账号（community_signal_counts，每日可刷），内容页「社群品味」两栏策展
- [ ] 相似推荐升级：接入官方相似账号端点，与既有相似账号数据互补（同赛道/同粉丝圈已先行覆盖）
...
- [ ] 更多分享形态：榜单卡 OG（/og/leaderboard.png）已上线；赛道名次版 / 倒计时版成员嵌入卡待补
