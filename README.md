...
- [ ] 社群日报 / 周报：每天自动生成一份社群战报（今日登阶、涨粉冠军、最爆内容、赛道表现、品牌声量），按日期归档、一键分享
- [ ] 今日曝光增量榜：按帖子每天新增浏览排「今天谁的内容在被疯转」，喂首页「今日动态」
- [ ] 多维时间榜：涨粉 / 曝光 / 发帖 / 评论统一到今天、昨天、近 7 天、近 30 天四档；榜单视图生成可分享、可收藏的独立链接
- [ ] 新锐潜力榜：粉丝量不大但内容效率极高的潜力账号，分粉丝档展示，回答「现在该关注谁」
- [ ] 最勤快博主榜：按周均发帖数排「最活跃的内容创作者」
- [ ] 声量趋势与情绪分布：首页品牌声量卡升级为趋势图 + 正 / 中 / 负情绪条
- [ ] 全站历史 Top 帖：突破 30 天窗口的「社群最火 10 帖」

### ② 看见彼此 —— 把成员连成一张网

- [ ] 赛道内名次与同赛道伙伴：成员页亮出「所在赛道近 N 天第几名」+ 同赛道 / 同标签账号（数据已在手，零成本）
- [ ] 社群内部互推图谱：从帖子正文的转发 / 引用扫出成员间真实互动边，喂影响力网络图
- [ ] 同粉丝圈博主：按粉丝样本重叠度推荐「真正同受众」的账号
- [ ] 共同关注与社群品味：成员们共同关注的外部大 V +「社群最近都在赞什么」策展
- [ ] 相似推荐升级：接入官方相似账号端点，与既有相似账号数据互补
- [ ] 关注与订阅：收藏成员、订阅赛道或成员，登阶与周报更新可触达
- [ ] 邀请裂变追踪：分享卡带邀请参数，「谁带来最多新成员」荣誉榜

### ③ 看见自己 —— 让成长更有仪式感

- [ ] 爆款 → 涨粉归因：成员页显示「这条爆款带来 ≈N 粉」，把内容与成长连成故事
- [ ] 最佳发帖时间：成员页「你的黄金时段」+ 内容页「社群黄金时段」
- [ ] 内容形态配方：带链接 / 纯文本 / 引用 / 线程帖的平均曝光对比，告诉成员什么形态最吃香
- [ ] 争议帖识别：评论远多于点赞的「最有讨论度」帖子视角
- [ ] 下一位称号倒计时：冲线在即升级为「还差 N 粉 · 预计 X 天」
- [ ] 成员对比 PK：任意两位成员同屏对比 + PK 分享卡
- [ ] 年度影响力报告：年底自动生成全站 + 个人年度卡
- [ ] 成长纪念日与回顾卡：加入周年、称号达成回顾，一键分享
- [ ] 周冠军 / 月冠军：定期影响力榜，产生「本周王者」的叙事
- [ ] 影响力效率对比：帖均曝光 vs 同量级中位、环比变化，让每个成员知道「自己强在哪」

### ④ 看见价值 —— 让社群成为可展示的证据

- [ ] 成员被提及榜：每位成员的「被讨论热度」新维度，影响力指数升级（被讨论热度）
- [ ] 社群能量报告：社群能量全景聚合报告（总影响力、赛道分布、粉丝质量、KOL 名单），一键导出
- [ ] 更多分享形态：榜单卡 / 赛道卡 / 日报卡 / 赛道名次版与倒计时版成员嵌入卡的分享图
- [ ] 数据透明升级：站点级数据说明、历史归档，所有数字可追溯

### ⑤ 打牢底座 —— 让站本身更好被找到

- [ ] 导航收敛：顶栏改「首页 / 博主 / 内容」三项（榜单·广场·赛道并为博主模块三视图，日报并入首页），现有 URL 与 SEO 全部保留
- [ ] 榜单排序与时间进 URL：每个视图都能分享、能被搜索引擎收录
- [ ] RSS 订阅：登阶事件 / 社群日报 / 赛道动态输出 RSS，零基础设施落地订阅
- [ ] 站点 AI 索引与 SEO 持续优化
- [ ] 性能、缓存与采集成本持续优化
