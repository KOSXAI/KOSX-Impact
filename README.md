...
- [ ] 声量趋势与情绪分布：首页品牌声量卡升级为趋势图 + 正 / 中 / 负情绪条（情绪分布已上线，趋势图待补）
...
- [x] 成员被提及榜：每位成员的「被讨论热度」新维度（榜单第六个榜上线，每日 09:30 自动同步）
- [ ] 社群能量报告：社群能量全景聚合报告（总影响力、赛道分布、粉丝质量、KOL 名单），一键导出
- [ ] 更多分享形态：榜单卡 / 赛道卡 / 日报卡 / 赛道名次版与倒计时版成员嵌入卡的分享图
- [ ] 数据透明升级：站点级数据说明、历史归档，所有数字可追溯（口径页已在线，归档待补）
...
- [ ] 站点 AI 索引与 SEO 持续优化（llms.txt 待补）
- [ ] 性能、缓存与采集成本持续优化
